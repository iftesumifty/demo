...
<html lang="en">
  ...
  <body  style="margin-left: 5rem;"><br>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <input type="text" class="form-control" name='name'id="exampleInputPassword1"placeholder="enter email">
</div>
...
<td>{{ $user->phone }}</td>
      ...
      <td>
        ...
        <a class="btn-btn-primary" href="{{route('editt',$user->id)}}" role="buttton">Edit</a>
